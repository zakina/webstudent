    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/stage')) {
            ...
            if ($pathinfo === '/stage/ajouter') {
                return array (  '_controller' => 'webStudent\\StageBundle\\Controller\\StageController::stageAjouterAction',  '_route' => 'Stage_ajouter',);
            }

            // web_student_stage_homepage
            if (0 === strpos($pathinfo, '/stageTest') && preg_match('#^/stageTest/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // web_sudent_stage_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'web_sudent_stage_homepage')), array (  '_controller' => 'webSudent\\StageBundle\\Controller\\DefaultController::indexAction',));
        }

        // SalutEverybody
        if ($pathinfo === '/affichSalut') {
            return array (  '_controller' => 'webStudent\\EtudiantBundle\\Controller\\DefaultController::indexAction',  '_route' => 'SalutEverybody',);
        }
        ...
        if (0 === strpos($pathinfo, '/etudiant')) {
            ...
            if (0 === strpos($pathinfo, '/etudiant/consulter')) {
                // Etudiant_consulter
                if (preg_match('#^/etudiant/consulter/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                // EtudiantAvecStages_consulter
                if (0 === strpos($pathinfo, '/etudiant/consulterAvecStages') && preg_match('#^/etudiant/consulterAvecStages/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'EtudiantAvecStages_consulter')), array (  '_controller' => 'webStudent\\EtudiantBundle\\Controller\\EtudiantController::etudiantAvecStagesConsulterAction',));
                }
            ...
            // Etudiant_lister
            if ($pathinfo === '/etudiant/lister') {
                return array (  '_controller' => 'webStudent\\EtudiantBundle\\Controller\\EtudiantController::etudiantListerAction',  '_route' => 'Etudiant_lister',);
            }
